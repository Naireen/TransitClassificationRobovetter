...
for qq, name in enumerate(data_names[3990:4015]):
    if qq % 1000 ==999:
        print qq
    ...
    np.savetxt("../InvModShiftVals/" + name[:-8] +"_feats_fixed_new.txt", total_Vals, header=head_txt)
    #break
    #print ("\n")
